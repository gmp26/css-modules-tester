...
var x__20587__auto__ = (((x == null))?null:x);
var m__20588__auto__ = (sablono.util.to_str[goog.typeOf(x__20587__auto__)]);
if(!((m__20588__auto__ == null))){
return m__20588__auto__.call(null,x);
} else {
var m__20588__auto____$1 = (sablono.util.to_str["_"]);
if(!((m__20588__auto____$1 == null))){
return m__20588__auto____$1.call(null,x);
} else {
...
var x__20587__auto__ = (((x == null))?null:x);
var m__20588__auto__ = (sablono.util.to_uri[goog.typeOf(x__20587__auto__)]);
if(!((m__20588__auto__ == null))){
return m__20588__auto__.call(null,x);
} else {
var m__20588__auto____$1 = (sablono.util.to_uri["_"]);
if(!((m__20588__auto____$1 == null))){
return m__20588__auto____$1.call(null,x);
} else {
...
var len__20994__auto___21159 = arguments.length;
var i__20995__auto___21160 = (0);
while(true){
if((i__20995__auto___21160 < len__20994__auto___21159)){
args__21001__auto__.push((arguments[i__20995__auto___21160]));

var G__21161 = (i__20995__auto___21160 + (1));
i__20995__auto___21160 = G__21161;
continue;
} else {
}
break;
...
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(argseq__21002__auto__);
});
...
sablono.util.as_str.cljs$lang$applyTo = (function (seq21158){
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq21158));
});
/**
...
var vec__21163 = clojure.string.split.call(null,cljs.core.name.call(null,k),/-/);
var first_word = cljs.core.nth.call(null,vec__21163,(0),null);
var words = cljs.core.nthnext.call(null,vec__21163,(1));
...
var G__21165 = clojure.set.rename_keys.call(null,m,kmap);
if(cljs.core.map_QMARK_.call(null,new cljs.core.Keyword(null,"style","style",-496642736).cljs$core$IFn$_invoke$arity$1(m))){
return cljs.core.update_in.call(null,G__21165,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"style","style",-496642736)], null),sablono$util$camel_case_keys);
} else {
return G__21165;
}
} else {
...
return clojure.string.join.call(null," ",cljs.core.flatten.call(null,cljs.core.map.call(null,(function (p1__21166_SHARP_){
if(typeof p1__21166_SHARP_ === 'string'){
return p1__21166_SHARP_;
} else {
return cljs.core.seq.call(null,p1__21166_SHARP_);
...
var x__$1 = this;
if(cljs.core.truth_((function (){var or__19924__auto__ = x__$1.hasDomain();
...
//# sourceMappingURL=util.js.map?rel=1472593621366