...
var args27591 = [];
var len__20994__auto___27595 = arguments.length;
var i__20995__auto___27596 = (0);
while(true){
if((i__20995__auto___27596 < len__20994__auto___27595)){
args27591.push((arguments[i__20995__auto___27596]));

var G__27597 = (i__20995__auto___27596 + (1));
i__20995__auto___27596 = G__27597;
continue;
} else {
}
break;
...
var G__27594 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__27594,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__27594;
}
});
...
var or__19924__auto__ = cljs.test._STAR_current_env_STAR_;
...
var len__20994__auto___27602 = arguments.length;
var i__20995__auto___27603 = (0);
while(true){
if((i__20995__auto___27603 < len__20994__auto___27602)){
args__21001__auto__.push((arguments[i__20995__auto___27603]));

var G__27604 = (i__20995__auto___27603 + (1));
i__20995__auto___27603 = G__27604;
continue;
} else {
}
break;
...
return cljs.test.update_current_env_BANG_.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__21002__auto__);
});
...
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq27599){
...
return cljs.test.update_current_env_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__27600,G__27601,seq27599__$2);
});
...
var file = cljs.core.get.call(null,map__27608__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__27608__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__27608__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__27608,map__27608__$1,file,line,column){
return (function (p1__27605_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__27605_SHARP_));
});})(map__27608,map__27608__$1,file,line,column))
 ...
 */
cljs.test.report = (function (){var method_table__20849__auto__ = cljs.core.atom.call(null,cljs.core.PersistentArrayMap.EMPTY);
...
return (new cljs.core.MultiFn(cljs.core.symbol.call(null,"cljs.test","report"),((function (method_table__20849__auto__,prefer_table__20850__auto__,method_cache__20851__auto__,cached_hierarchy__20852__auto__,hierarchy__20853__auto__){
return (function (m){
...
var formatter_fn = (function (){var or__19924__auto__ = new cljs.core.Keyword(null,"formatter","formatter",-483008823).cljs$core$IFn$_invoke$arity$1(cljs.test.get_current_env.call(null));
if(cljs.core.truth_(or__19924__auto__)){
return or__19924__auto__;
} else {
...
var temp__4657__auto___27610 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__4657__auto___27610)){
var message_27611 = temp__4657__auto___27610;
cljs.core.println.call(null,message_27611);
} else {
}
...
var temp__4657__auto___27612 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__4657__auto___27612)){
var message_27613 = temp__4657__auto___27612;
cljs.core.println.call(null,message_27613);
} else {
}
...
var temp__4655__auto__ = (function (){var and__19912__auto__ = typeof exception.stack === 'string';
if(and__19912__auto__){
var G__27619 = exception.stack;
var G__27619__$1 = (((G__27619 == null))?null:clojure.string.split_lines.call(null,G__27619));
var G__27619__$2 = (((G__27619__$1 == null))?null:cljs.core.get.call(null,G__27619__$1,depth));
if((G__27619__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__27619__$2);
}
} else {
...
var vec__27620 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__27620,(0),null);
var column = cljs.core.nth.call(null,vec__27620,(1),null);
var vec__27621 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__27621,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__27621,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__27621,(2),null);
...
var m__$1 = (function (){var G__27623 = (((new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m) instanceof cljs.core.Keyword))?new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m).fqn:null);
switch (G__27623) {
case "fail":
...
var G__27629 = (function (){var G__27628 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__27628);
} else {
return G__27628;
}
})();
...
return cljs.core.vary_meta.call(null,G__27631,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
}catch (e27634){var e = e27634;
var G__27635 = (((e instanceof cljs.core.Keyword))?e.fqn:null);
switch (G__27635) {
...
var vec__27638 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__27638,(0),null);
var types = vec__27638;
...
var ns = cljs.core.nth.call(null,vec__27647,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__27647,(1),null);
return ((function (vec__27647,ns,vars__$1){
return (function (){
...
var G__27648 = (((cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures) instanceof cljs.core.Keyword))?cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures).fqn:null);
switch (G__27648) {
case "async":
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__27648,env,once_fixtures,each_fixtures,vec__27647,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__27648,env,once_fixtures,each_fixtures,vec__27647,ns,vars__$1){
return (function (){
var seq__27649 = cljs.core.seq.call(null,vars__$1);
var chunk__27650 = null;
var count__27651 = (0);
var i__27652 = (0);
while(true){
if((i__27652 < count__27651)){
var v = cljs.core._nth.call(null,chunk__27650,i__27652);
var temp__4657__auto___27654 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__4657__auto___27654)){
var t_27655 = temp__4657__auto___27654;
each_fixture_fn.call(null,((function (seq__27649,chunk__27650,count__27651,i__27652,t_27655,temp__4657__auto___27654,v,each_fixture_fn,G__27648,env,once_fixtures,each_fixtures,vec__27647,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_27655)));
});})(seq__27649,chunk__27650,count__27651,i__27652,t_27655,temp__4657__auto___27654,v,each_fixture_fn,G__27648,env,once_fixtures,each_fixtures,vec__27647,ns,vars__$1))
);
} else {
}

var G__27656 = seq__27649;
var G__27657 = chunk__27650;
var G__27658 = count__27651;
var G__27659 = (i__27652 + (1));
seq__27649 = G__27656;
chunk__27650 = G__27657;
count__27651 = G__27658;
i__27652 = G__27659;
continue;
} else {
var temp__4657__auto__ = cljs.core.seq.call(null,seq__27649);
if(temp__4657__auto__){
var seq__27649__$1 = temp__4657__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__27649__$1)){
var c__20735__auto__ = cljs.core.chunk_first.call(null,seq__27649__$1);
var G__27660 = cljs.core.chunk_rest.call(null,seq__27649__$1);
var G__27661 = c__20735__auto__;
var G__27662 = cljs.core.count.call(null,c__20735__auto__);
var G__27663 = (0);
seq__27649 = G__27660;
chunk__27650 = G__27661;
count__27651 = G__27662;
i__27652 = G__27663;
continue;
} else {
var v = cljs.core.first.call(null,seq__27649__$1);
var temp__4657__auto___27664__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__4657__auto___27664__$1)){
var t_27665 = temp__4657__auto___27664__$1;
each_fixture_fn.call(null,((function (seq__27649,chunk__27650,count__27651,i__27652,t_27665,temp__4657__auto___27664__$1,v,seq__27649__$1,temp__4657__auto__,each_fixture_fn,G__27648,env,once_fixtures,each_fixtures,vec__27647,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_27665)));
});})(seq__27649,chunk__27650,count__27651,i__27652,t_27665,temp__4657__auto___27664__$1,v,seq__27649__$1,temp__4657__auto__,each_fixture_fn,G__27648,env,once_fixtures,each_fixtures,vec__27647,ns,vars__$1))
);
} else {
}

var G__27666 = cljs.core.next.call(null,seq__27649__$1);
var G__27667 = null;
var G__27668 = (0);
var G__27669 = (0);
seq__27649 = G__27666;
chunk__27650 = G__27667;
count__27651 = G__27668;
i__27652 = G__27669;
continue;
}
} else {
...
});})(each_fixture_fn,G__27648,env,once_fixtures,each_fixtures,vec__27647,ns,vars__$1))
);
});})(each_fixture_fn,G__27648,env,once_fixtures,each_fixtures,vec__27647,ns,vars__$1))
], null);
...
//# sourceMappingURL=test.js.map?rel=1472593626413